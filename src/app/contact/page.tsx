      ...
      <section className="relative h-[40vh]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-2xl">
            Get in touch with us to plan your perfect journey
          </p>
        </div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="uttarakhand">Uttarakhand Tours</option>
                    <option value="himachal">Himachal Pradesh Tours</option>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Travel Street, Dehradun, Uttarakhand, India</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@traveltech.com</p>
                      <p className="text-gray-600">support@traveltech.com</p>
                    </div>
                  </div>
